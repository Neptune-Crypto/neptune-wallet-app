...
fn add_commands<R: tauri::Runtime>(invoke: tauri::ipc::Invoke<R>) -> bool {
    let handler: fn(tauri::ipc::Invoke<R>) -> bool = tauri::generate_handler![
        ...
        command::commands::get_auto_lock_minutes,
        ...
        command::commands::set_auto_lock_minutes,
        ...
        rpc::commands::add_watch_only_address,
        rpc::commands::known_watch_only_addresses,
        rpc::commands::remove_watch_only_address,
        os::is_win11,
        os::os_info,
        os::platform,
        logger::clear_logs,
