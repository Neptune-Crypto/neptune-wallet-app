  ...
  return (
    <Flex direction="column" justify={"center"} align="center" gap={8} w={"100%"}>
      ...
      <Text fw={600} style={{ textAlign: "center" }}>
        Keep a reminder of your recovery phrase somewhere safe. If you lose it, no one can
        help you get it back. Even worse, you won’t be able to access your account ever again.
      </Text>
